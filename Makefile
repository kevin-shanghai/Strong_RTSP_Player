...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ?? 29 08:48:06 2013
# Project:  player.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++ -o Makefile player.pro
#############################################################################
...
Makefile: player.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++ -o Makefile player.pro
