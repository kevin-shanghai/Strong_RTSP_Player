...
void VLCMainwindow::initMenus() {
    ...
    plt.setColor( QPalette::Window, Qt::darkGray);
    ...
    QAction *Openurl = new QAction("&OpenURL", this);
    ...
    connect(Openurl, SIGNAL(triggered()), this, SLOT(ShowopenURLDialog()));
    connect(playAc, SIGNAL(triggered()), this, SLOT(play()));
    connect(Quit, SIGNAL(triggered()), qApp, SLOT(quit()));
}

void VLCMainwindow::initComponents() {
...
void VLCMainwindow::ShowopenURLDialog()
{
 URLDialog  = new OpenURLDialog;
 URLDialog->resize(700, 100);
 URLDialog->show();
}
...
void VLCMainwindow::closeEvent(QCloseEvent *event) {
    stop();
    event->accept();
}
